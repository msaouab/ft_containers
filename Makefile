...
#    Updated: 2022/12/26 13:19:30 by msaouab          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
all : credit $(NAME) vector stack map rb_tree set it
...
$(NAME_I): $(OBJ_It)
		@$(CC) $(CFLAGS) $(OBJ_It) -o $(NAME_I)
		@echo " $(bold)$(magenta)Combilation Iterators Done.$(ED) $(LINE_CLEAR)"
		@rm -f $(OBJ_It)
